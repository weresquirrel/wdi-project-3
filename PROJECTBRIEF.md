...
Not only will you be asked to **exercise additional creativity** in designing your own project, **your instructors will partner you with other classmates to architect, design, and collaboratively build a Full-Stack application using Mongo, Express, Node and Angular.**
...
For this project, we want you to work with your team to build a creative product that you actually think someone will want to use. We don't have time to do tons of customer research or anything, but take some time to brainstorm. If you're struggling for ideas, the ones below can get you started.

##### Bucketli.st
Besides finishing WDI, you surely have one or two things you'd love to do before you die. Let's get 'em on paper! By building it out as an API now, you'll be all prepped for when you sign up for the part-time mobile class and build that killer app.
